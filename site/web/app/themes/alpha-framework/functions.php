	...
	function alpha_post_meta() {
		...
		if ( get_post_type() === 'post' ) {
			...
			if ( comments_open() ) :
				...
				comments_popup_link(
					__( 'Leave a comment', 'alpha' ),
					__( 'One comment so far', 'alpha' ),
					__(' View all  % comments', 'alpha' )
				);
				echo '</span>';
				echo '</li>';
			endif;
			...
			*/
			register_sidebar(
				array(
					...
					'id'            => 'sidebar-1',
					'description'   => __('Appers on posts and pages', 'alpha' ),
			...
			register_sidebar(
				array(
					...
					'id'            => 'sidebar-2',
					'description'   => __('Appers on the footer', 'alpha' ),
